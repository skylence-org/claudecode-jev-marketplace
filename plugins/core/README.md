...
| `/core:session-handoff`, `/core:uninstall-claude`, `/core:purge-claude-user-scope` | skills | Unchanged from core-claude. Two upstream setup skills for a retired substrate are not carried. |
